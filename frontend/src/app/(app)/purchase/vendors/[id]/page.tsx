  ...
  return (
    <>
      ...
      <div className="grid gap-4 lg:grid-cols-[0.8fr_1.2fr]">
        <Card className="p-5">
          <h3 className="text-xl font-bold">Timberland Woods</h3>
          <p className="mt-2 text-sm text-[var(--muted)]">Strategic wood supplier with 94% reliability and 8-day average lead time.</p>
